...
> 개인 프로젝트
> 기획 · UI 설계 · 프론트엔드 · 백엔드 · DB 설계 전부 단독 구현

---

## 프로젝트 소개

- 경기 직관 후 기억이 점점 흐려지는 경험에서 출발
- 메모 앱이 아닌 **경기 기록에 특화된 구조**를 직접 설계
- 실제 사용을 전제로 **모바일 웹 UX 중심**으로 설계
...
- **diaries** : 경기 기록 핵심 테이블
- **users** : 사용자 정보
- **likes** : 기록 좋아요 (중복 방지 UNIQUE 제약)
- **comments** : 댓글 (작성자 기준 삭제 가능)
- **diary_photos** : 이미지 첨부
